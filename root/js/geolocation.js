...
var redNorthLayer = L.geoJSON.ajax('/data/zone-red-north.json', {style:style});
var blueNorthLayer = L.geoJSON.ajax('/data/zone-blue-north.json', {style:style});
var purpleNorthLayer = L.geoJSON.ajax('/data/zone-purple-north.json', {style:style});
var greenNorthLayer = L.geoJSON.ajax('/data/zone-green-north.json', {style:style});
var yellowNorthLayer = L.geoJSON.ajax('/data/zone-yellow-north.json', {style:style});
var redSouthLayer = L.geoJSON.ajax('/data/zone-red-south.json', {style:style});
var blueSouthLayer = L.geoJSON.ajax('/data/zone-blue-south.json', {style:style});
var purpleSouthLayer = L.geoJSON.ajax('/data/zone-purple-south.json', {style:style});
var greenSouthLayer = L.geoJSON.ajax('/data/zone-green-south.json', {style:style});
var yellowSouthLayer = L.geoJSON.ajax('/data/zone-yellow-south.json', {style:style});
